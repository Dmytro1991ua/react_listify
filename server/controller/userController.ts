...
// import { DecodedIdToken } from "firebase-admin/lib/auth/token-verifier";
// import { firebaseAuth } from "../config/firebase.config";
// import { FirebaseUser } from "../models/userSchema";

// const createNewUser = asyncHandler(async (req: Request, res: Response, decodedIdToken: DecodedIdToken) => {
...
// const updateNewUser = asyncHandler(async (req: Request, res: Response, decodedIdToken: DecodedIdToken) => {
//   const filterUsers = { uid: decodedIdToken.user_id };
//   const options = {
//     upsert: true,
//     new: true,
...
//     const userExists = await FirebaseUser.findOne({ uid: decodedIdToken.user_id });
